...
<body style="background-image: url('14.jpg');background-repeat: no-repeat;  
...
{
    $key=$_POST['key'];
    $q="SELECT * FROM crime_record WHERE criminal_id='$key'";
